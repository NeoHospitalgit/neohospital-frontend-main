...
import Professionsserviceslist from "./Professionsserviceslist";
import Professionsservicesimg from "../../../Assets/Services/Professions Allied to Medicine.jpeg";
import './clinicalservice.css';
function Professionsservices() {
  return (
    <>
...
export default Professionsservices;
